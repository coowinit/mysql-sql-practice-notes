...
## 截图上传建议
截图建议统一使用 PNG 格式，并保持文件名与 SQL 编号一致。例如：

```text
docs/screenshots/04-01.png
docs/screenshots/04-02.png
docs/screenshots/11-02.png
docs/screenshots/16-05.png
```
如果使用 phpMyAdmin，建议截图包含 SQL 执行结果表格；如果使用 Navicat / DBeaver / DataGrip，建议截图包含 SQL 编辑区和结果区，方便后期回顾。
